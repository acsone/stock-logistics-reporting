...
class StockAverageDailySale(models.Model):
    ...
    def _check_view(self):
        try:
            ...
            new_self.env.cr.execute("SELECT ispopulated FROM pg_matviews WHERE matviewname = %s;", (self._table,))
    ...
    def refresh_view(self):
        self.env.cr.execute("refresh materialized view CONCURRENTLY %s", (AsIs(self._table),))
